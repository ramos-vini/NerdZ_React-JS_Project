...
import {theme as muiTheme} from '../../global/muiTheme';
import './checkout.css'
...
function Copyright() {
  return (
    <Typography variant="body2" color="text.secondary" align="center">
      ...
      <Link color="inherit" className='checkoutLink'>
        NerdZ
      </Link>{' '}
...
function getStepContent(step, idx) {
  switch (step) {
    case 0:
      return <AddressForm idx={idx}/>;
    case 1:
      return <PaymentForm idx={idx} />;
    case 2:
      return <Review idx={idx}/>;
    default:
      ...
      <Container component="main" maxWidth="sm" sx={{ mb: 4 }}>
        <Paper variant="outlined" sx={{ my: { xs: 3, md: 6 }, p: { xs: 2, md: 3 } }}>
          ...
          {activeStep === steps.length ? (
            ...
            <React.Fragment>
              {getStepContent(activeStep, props.idx)}
